...
namespace ScamSimulatorCore.core
{
    class SimOptions
    {
        ...
        public double IntelligenceDistributionMean { get; set; } = 0.75;
        ...
        public int TileSetPlateauIncrementOffset { get; set; } = 1000;
        public int TileSetPlateauStart { get; set; } = 10;
        public int TileSetPlateauIncrement { get; set; } = 30;
